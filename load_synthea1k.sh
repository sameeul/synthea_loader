...
DATASET_NAME="synthea1k"  # Change this to use different datasets (synthea1k, synthea10k, synthea23m, etc.)
...
load_csv "visit_occurrence" "$PATIENT_DIR/visit_occurrence.csv" ','
load_csv "condition_occurrence" "$PATIENT_DIR/condition_occurrence.csv" ','
load_csv "drug_exposure" "$PATIENT_DIR/drug_exposure.csv" ','
load_csv "procedure_occurrence" "$PATIENT_DIR/procedure_occurrence.csv" ','
load_csv "measurement" "$PATIENT_DIR/measurement.csv" ','
load_csv "observation" "$PATIENT_DIR/observation.csv" ','

log "Step 7: Loading era tables (depend on clinical events)..."
load_csv "drug_era" "$PATIENT_DIR/drug_era.csv" ','
load_csv "condition_era" "$PATIENT_DIR/condition_era.csv" ','
